...
<head>
  ...
  <title>SchoolMessenger - Messagerie ultra rapide</title>
  <!-- Favicon -->
...
<body>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./examples/icons.html">
              <i class="ni ni-email-83 text-blue"></i> Messages
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./examples/maps.html">
              <i class="ni ni-bullet-list-67 text-orange"></i> Administration
            </a>
          </li>
        </ul>
        <!-- Divider -->
  ...
  <div class="main-content">
    ...
    <!-- Header -->
    <div class="header bg-gradient-primary pb-0 pt-0 pt-md-8">
    </div>
    <!-- Page content -->
